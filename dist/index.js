...
var g = class extends e {
	...
	constructor() {
		super(), this.density = 40, this.wind = .1, this.theme = "forest", this.tile = 40, this.mouse = {
			x: -9999,
			y: -9999
		}, this.width = 0, this.height = 0, this.layers = [], this.timeOffset = Math.random() * 1e3, this._groundRerender = !0, this._running = !1, this._visible = !0, this._ready = !1, this._raf = null;
	}
	_validateProps() {
	...
	setConfig(e) {
		if (e.density - e.tile > 50) throw "The difference between density and tile is too great.";
	...
	_applyTheme() {
		...
		this.grassColor = e, this.groundColor = t, this._groundRerender = !0;
	}
	_initScene() {
		this._validateProps(), this._applyTheme(), this._groundRerender = !0, this.layers = c({
			width: this.width,
			height: this.height,
			density: this.density,
			tile: this.tile
		}), this._ready || (this._ready = !0, this.dispatchEvent(new CustomEvent("grass-ready")));
	}
	_render() {
...
customElements.define("grassly-component", g);
//#endregion
